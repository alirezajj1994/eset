        ...
        if msg.inline_query then
          ...
          if Q.query:match("^-(%d+,%S+)") then
            ...
            if lang == "Fa" then
              ...
              answer(Q.id, "settings", "Menu", chat, "`لطفا بخش مورد نظر خود را انتخاب کنید ;)`", keyboard)
            elseif lang == "En" then
              keyboard.inline_keyboard = {
                {
                  {
        ...
        if msg.callback_query then
          ...
          if having_access(Q.from.id, chat, Q.id) then
            if Q.data:match("FirstMenuFa") then
              ...
              edit(Q.inline_message_id, "`لطفا بخش مورد نظر خود را انتخاب کنید ;)`", keyboard)
          ...
          if having_access(Q.from.id, chat, Q.id) then
            if Q.data:match("GroupCentPageOneFa") then
              ...
              local hash6 = database:get("bot:duplipost:mute" .. chat)
              local hash7 = database:get("bot:forward:mute" .. chat)
